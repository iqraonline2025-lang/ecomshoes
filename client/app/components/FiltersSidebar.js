...
const FiltersSidebar = ({ onFilterChange, currentFilters = { brand: [], size: [], color: [] } }) => {
  ...
  // Helper to handle multiple selection (Brands, Sizes, etc.)
  ...
  return (
    <div className="border-b border-gray-100 pb-6">
      <button onClick={() => setIsOpen(!isOpen)} className="w-full flex justify-between items-center group">
        <span className="text-xs font-black uppercase tracking-widest group-hover:text-red-600 transition-colors">{title}</span>
